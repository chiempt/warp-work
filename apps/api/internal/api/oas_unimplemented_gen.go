...
func (UnimplementedHandler) ArchiveContext(ctx context.Context, params ArchiveContextParams) (r ArchiveContextRes, _ error) {
...
func (UnimplementedHandler) CreateCommitment(ctx context.Context, req *CreateCommitmentRequest) (r CreateCommitmentRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
func (UnimplementedHandler) UpdateContext(ctx context.Context, req *UpdateContextRequest, params UpdateContextParams) (r UpdateContextRes, _ error) {
	return r, ht.ErrNotImplemented
}
